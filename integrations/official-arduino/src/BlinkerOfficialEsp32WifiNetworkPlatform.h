#ifndef BLINKER_OFFICIAL_ESP32_WIFI_NETWORK_PLATFORM_H
#define BLINKER_OFFICIAL_ESP32_WIFI_NETWORK_PLATFORM_H

#include "BlinkerOfficialEsp32Storage.h"
...
// Minimal network/storage boundary shared by legacy and DeviceKey WiFi
// compositions. Identity policy, ownership and cloud enrollment do not belong
