...
Result ArduinoCryptoProvider::x25519PublicKey(
    ByteView privateKey,
...
Result ArduinoCryptoProvider::x25519(
    ByteView privateKey,
...
Result ArduinoCryptoProvider::aes256GcmEncrypt(
    ByteView key,
    ByteView nonce,
    ByteView associatedData,
    ByteView plaintext,
...
Result ArduinoCryptoProvider::aes256GcmDecrypt(
    ByteView key,
    ByteView nonce,
    ByteView associatedData,
...
Result ArduinoCryptoProvider::verifyDigest(
    ByteView publicKey,
    ByteView digest,
    ByteView signature) {
