...
// int BlinkerSerialAIR202::aliPrint(const String & s)
// {
//     if (!checkPrintSpan()) {
//         respTime = millis();
//         return false;
...
// int BlinkerSerialAIR202::duerPrint(const String & s)
// {
//     if (!checkPrintSpan()) {
//         respTime = millis();
//         return false;
...
// int BlinkerSerialAIR202::print(const String & s, bool needCheck)
...
// int BlinkerSerialAIR202::connect()
// {
//     stream->println(STRING_format(BLINKER_CMD_MCONFIG_REQ) +
//                     "=\"" + MQTT_ID_GPRS + 
//                     "\",\"" + MQTT_NAME_GPRS + 
//                     "\",\"" + MQTT_KEY_GPRS + "\"");
// }
