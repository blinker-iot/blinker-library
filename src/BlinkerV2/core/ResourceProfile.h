...
#endif
#ifndef BLINKER_TELEMETRY_LEASE_SLOTS
#define BLINKER_TELEMETRY_LEASE_SLOTS 2
#endif
...
#endif
#ifndef BLINKER_TELEMETRY_LEASE_SLOTS
#define BLINKER_TELEMETRY_LEASE_SLOTS 4
#endif
...
#if BLINKER_TELEMETRY_LEASE_SLOTS < 1 || \
    BLINKER_TELEMETRY_LEASE_SLOTS > 8
#error "BLINKER_TELEMETRY_LEASE_SLOTS must be between 1 and 8"
#endif
...
struct ActiveResourceProfile {
    enum : size_t {
        ...
        telemetryLeaseCapacity = BLINKER_TELEMETRY_LEASE_SLOTS
    };
};
