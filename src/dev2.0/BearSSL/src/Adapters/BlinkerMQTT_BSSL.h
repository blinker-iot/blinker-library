#ifndef BlinkerMQTT_BSSL_H
#define BlinkerMQTT_BSSL_H
...
char MQTT_HOST[BLINKER_MQTT_HOST_SIZE];
uint16_t MQTT_PORT;
// char MQTT_DEVICEID[BLINKER_MQTT_DEVICEID_SIZE];
char MQTT_ID[BLINKER_MQTT_ID_SIZE];
char MQTT_NAME[BLINKER_MQTT_NAME_SIZE];
char MQTT_KEY[BLINKER_MQTT_KEY_SIZE];
char MQTT_PRODUCTINFO[BLINKER_MQTT_PINFO_SIZE];
char UUID[BLINKER_MQTT_UUID_SIZE];
// char DEVICE_NAME[BLINKER_MQTT_DEVICENAME_SIZE];
char DEVICE_NAME[BLINKER_MQTT_DEVICEID_SIZE];
...
// char msgBuf[BLINKER_MAX_READ_SIZE];
char* msgBuf;//[BLINKER_MAX_READ_SIZE];
bool isFresh = false;
