...
#include "Functions/BlinkerBLESerial.h"
#include "Blinker/BlinkerProtocol.h"
#include "modules/ArduinoJson/ArduinoJson.h"
...
class BlinkerBLE: public BlinkerProtocol<BlinkerBLESerial>
{
    typedef BlinkerProtocol<BlinkerBLESerial> Base;

    public :
        BlinkerBLE(BlinkerBLESerial &transp) : Base(transp) {}
