...
#define BLINKER_CMD_POWERSTATE_NUMBER   1

#define BLINKER_CMD_COLOR_NUMBER        2

#define BLINKER_CMD_COLORTEMP_NUMBER    3

#define BLINKER_CMD_BRIGHTNESS_NUMBER   4

#define BLINKER_CMD_TEMP_NUMBER         5

#define BLINKER_CMD_HUMI_NUMBER         6

#define BLINKER_CMD_PM25_NUMBER         7
