...
#define BLINKER_EEP_ADDR_AUTO           (BLINKER_EEP_ADDR_AUTOID + BLINKER_AUTOID_SIZE)

#define BLINKER_AUTODATA_SIZE           4

#define BLINKER_EEP_ADDR_TARGETKEY      (BLINKER_EEP_ADDR_AUTO + BLINKER_AUTODATA_SIZE)

#define BLINKER_TARGETKEY_SIZE          12

#define BLINKER_EEP_ADDR_TARGETDATA     (BLINKER_EEP_ADDR_TARGETKEY + BLINKER_TARGETKEY_SIZE)
...
#define BLINKER_EEP_ADDR_LINKDEVICE1    (BLINKER_EEP_ADDR_TARGETDATA + BLINKER_TARGETDATA_SIZE)
...
#define BLINKER_ONE_AUTO_DATA_SIZE      (BLINKER_AUTOID_SIZE + BLINKER_AUTODATA_SIZE + BLINKER_TARGETKEY_SIZE + BLINKER_TARGETDATA_SIZE + BLINKER_LINKDEVICE_SIZE + (BLINKER_LINKDEVICE_SIZE + BLINKER_LINKTYPE_SIZE + BLINKER_LINKDATA_SIZE) * 2)
