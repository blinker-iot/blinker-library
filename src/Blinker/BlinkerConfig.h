...
#define BLINKER_EEP_ADDR_AUTOID         (BLINKER_EEP_ADDR_AUTO_START)
...
#define BLINKER_EEP_ADDR_LINKDEVICE     (BLINKER_EEP_ADDR_TARGETDATA + BLINKER_TARGETDATA_SIZE)
...
#define BLINKER_LINKDATA_SIZE           64
