...
#define BLINKER_VERSION                 "0.5.01250522"
...
#define BLINKER_DEVICE_HEARTBEAT_TIME   600UL
...
#define BLINKER_OBJECT_NOT_AVAIL        -1
    ...
    #if defined(ESP8266) || defined(ESP32) || defined(ARDUINO_ARCH_RENESAS)
...
#define BLINKER_DATA_UPDATE_COUNT       2
    ...
    #define BLINKER_MIOT_CFG_NUM                0

    #define BLINKER_MIOT_PARAM_NUM              1
...
*/
    ...
    #define BLINKER_CMD_PRO_AUTH_GET_NUMBER     34

    #define BLINKER_CMD_PRO_AUTH_NUMBER         35
...
// #endif
    ...
    defined(BLINKER_MQTT) || defined(BLINKER_WIFI) || defined(BLINKER_WIFI_AT)
...
#if defined(BLINKER_WIFI) || defined(BLINKER_MQTT) || \
    defined(BLINKER_WIFI_AT) || defined(BLINKER_PRO) || \
