...
#define BLINKER_MAX_DATA_COUNT          24
    ...
    #define BLINKER_EEP_ADDR_EVENT_KEY1             (BLINKER_EEP_ADDR_EVENT_DATA1 + BLINKER_EVENT_DATA1_SIZE)
    ...
    #define BLINKER_EEP_ADDR_EVENT_MSG              (BLINKER_EEP_ADDR_EVENT_DATA2 + BLINKER_EVENT_KEY2_SIZE)
