...
static const char *TAG_AT_BASE = "[BlinkerMQTTATBase] ";
...
#endif
{
    ...
    switch (_bitSet)
    {
        case BLINKER_SERIAL_5N1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_5N1"));
            return SERIAL_5N1;
        case BLINKER_SERIAL_6N1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_6N1"));
            return SERIAL_6N1;
        case BLINKER_SERIAL_7N1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_7N1"));
            return SERIAL_7N1;
        case BLINKER_SERIAL_8N1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_8N1"));
            return SERIAL_8N1;
        case BLINKER_SERIAL_5N2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_5N2"));
            return SERIAL_5N2;
        case BLINKER_SERIAL_6N2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_6N2"));
            return SERIAL_6N2;
        case BLINKER_SERIAL_7N2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_7N2"));
            return SERIAL_7N2;
        case BLINKER_SERIAL_8N2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_8N2"));
            return SERIAL_8N2;
        case BLINKER_SERIAL_5E1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_5E1"));
            return SERIAL_5E1;
        case BLINKER_SERIAL_6E1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_6E1"));
            return SERIAL_6E1;
        case BLINKER_SERIAL_7E1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_7E1"));
            return SERIAL_7E1;
        case BLINKER_SERIAL_8E1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_8E1"));
            return SERIAL_8E1;
        case BLINKER_SERIAL_5E2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_5E2"));
            return SERIAL_5E2;
        case BLINKER_SERIAL_6E2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_6E2"));
            return SERIAL_6E2;
        case BLINKER_SERIAL_7E2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_7E2"));
            return SERIAL_7E2;
        case BLINKER_SERIAL_8E2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_8E2"));
            return SERIAL_8E2;
        case BLINKER_SERIAL_5O1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_5O1"));
            return SERIAL_5O1;
        case BLINKER_SERIAL_6O1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_6O1"));
            return SERIAL_6O1;
        case BLINKER_SERIAL_7O1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_7O1"));
            return SERIAL_7O1;
        case BLINKER_SERIAL_8O1 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_8O1"));
            return SERIAL_8O1;
        case BLINKER_SERIAL_5O2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_5O2"));
            return SERIAL_5O2;
        case BLINKER_SERIAL_6O2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_6O2"));
            return SERIAL_6O2;
        case BLINKER_SERIAL_7O2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_7O2"));
            return SERIAL_7O2;
        case BLINKER_SERIAL_8O2 :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_8O2"));
            return SERIAL_8O2;
        default :
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("SerialConfig SERIAL_8N1"));
            return SERIAL_8N1;
...
class BlinkerSlaverAT
{
    public :
        ...
        void update(const String & data) {
            ...
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("serialize _set: "), _set);
            // return _isAT;
        }
    ...
    private :
        ...
        void serialize(const String & _data) {
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("serialize _data: "), _data);
            ...
            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("startCmd: "), startCmd);

            // startCmd = _data.substring(0, 3);
            // BLINKER_LOG(BLINKER_F("startCmd: "), startCmd);

            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("startCmd len: "), _data.length());
            ...
            if (startCmd == BLINKER_CMD_AT)
            {
                ...
                BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("serialize addr_end: "), addr_end);
                if (addr_end != -1)
                {
                    _set = AT_SETTING;

                    _atCmd = _data.substring(addr_start, addr_end);
                    BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("serialize _atCmd: "), _atCmd);
                }
                else
                {
                    addr_end = _data.indexOf("?");
                ...
                for (_paramNum = 0; _paramNum < 11; _paramNum++) {
                    ...
                    BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("serialize serData: "), serData);
                    BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("serialize addr_start: "), addr_start);
                    BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("serialize addr_end: "), addr_end);
                    ...
                    if (addr_end == -1) {
                        ...
                        if (addr_end != -1) {
                            ...
                            BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("_param0["), _paramNum, \
                        ...
                        BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("_param1["), _paramNum, \
                                        BLINKER_F("]: "), _param[_paramNum]);
                        // BLINKER_LOG_ALL(BLINKER_F("_set: "), _set);
                        _paramNum++;
                        return;
                    ...
                    BLINKER_LOG_ALL(TAG_AT_BASE, BLINKER_F("_param["), _paramNum, \
                                    BLINKER_F("]: "), _param[_paramNum]);
                }
                // return;
            }
