...
static inline String STRING_format(long long p) { return String((long)p); }
static inline String STRING_format(unsigned long long p) { return String((unsigned long)p); }
