...
#if defined(BLINKER_ARDUINOJSON) || defined(BLINKER_WIFI) || defined(BLINKER_BLE)
...
enum b_device_staus_t {
    BLINKER_WLAN_CONNECTING,
    BLINKER_WLAN_CONNECTED,
    BLINKER_WLAN_SMARTCONFIG_BEGIN,
    BLINKER_WLAN_APCONFIG_BEGIN,
    BLINKER_DEV_AUTHCHECK,
    BLINKER_DEV_REGISTER,
    BLINKER_DEV_CONNECTING,
    BLINKER_DEV_CONNECTED,
    BLINKER_DEV_DISCONNECTED
};
